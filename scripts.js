...
async function displaySearchResults(videos) {
    ...
    const apiKey = 'AIzaSyC22-T1cksl3HOXLVPi1JD-AeSGLOpqFSo'; // Reemplaza con tu propia API Key
...
function searchSongs(query) {
    const apiKey = 'AIzaSyC22-T1cksl3HOXLVPi1JD-AeSGLOpqFSo';  // Asegúrate de mantener tu API Key segura
