...
async function displaySearchResults(videos) {
    ...
    const apiKey = 'AIzaSyCDge5i6NW87uX_Qikd5mi6H7brKPiwfmI'; // Reemplaza con tu propia API Key
...
function searchSongs(query) {
    const apiKey = 'AIzaSyCDge5i6NW87uX_Qikd5mi6H7brKPiwfmI';  // Asegúrate de mantener tu API Key segura
